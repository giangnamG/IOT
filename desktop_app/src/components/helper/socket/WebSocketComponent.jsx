...
import { setDeviceStatus } from '../../../redux/DeviceStatus'
import { setStateWarningCount } from '../../../redux/WaringCountRedux'
...
export default function WebSocketComponent() {
    ...
    useEffect(() => {
        ...
        function onDeviceStatus(value) {
            dispatch(setDeviceStatus(value))
        }
        function onWaringCount(value) {
            dispatch(setStateWarningCount(value))
        }
        ...
        socket.on('waring_count', onWaringCount)
