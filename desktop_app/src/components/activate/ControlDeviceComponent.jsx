...
const labelStyle = {
    ...
    fontSize: '16px',
    fontWeight: 'bold',
    color: '#CCCCCC', // Màu xám nhạt để phù hợp với nền tối
    padding: '5px 10px',
    backgroundColor: '#2C2C2C', // Màu nền tối hơn nhưng vẫn khác biệt với nền tổng thể
    borderRadius: '8px',
    boxShadow: '0 2px 5px rgba(0, 0, 0, 0.3)', // Hiệu ứng đổ bóng nhẹ để nổi bật
    ...
    useEffect(() => {
        ...
        if (status !== undefined) {
            ...
            setDeviceStatus({
                ...
                lightBulbIsOn: status.lightBulb,
    ...
    return (
        <div style={controlBoxStyle}>
            ...
            <div style={{ flex: 1 }}>
                ...
                {/* FAN Control */}
                <Row style={{ paddingTop: 15 }} className="fade-in fade-in-2">
                    <Col md={5} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <label style={{
                            ...
                            color: '#CCCCCC', // Màu xám nhạt để phù hợp với nền tối
                            padding: '5px 10px',
                            backgroundColor: '#2C2C2C', // Màu nền tối hơn
                            borderRadius: '8px',
                            boxShadow: '0 2px 5px rgba(0, 0, 0, 0.3)', // Đổ bóng
                            display: 'inline-block',
                        }}>
                            Quạt
                        </label>
                    ...
                    <Col md={3} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <div>
                            <svg
                                ...
                                width="32" height="32"
                                viewBox="0 0 16 16">
                                <rect x="1" y="1" width="6" height="6" rx="1" className={`square square-1 ${toggles.allDeviceIsOn ? 'light-up' : ''}`}></rect>
                                <rect x="9" y="1" width="6" height="6" rx="1" className={`square square-2 ${toggles.allDeviceIsOn ? 'light-up' : ''}`}></rect>
                                <rect x="1" y="9" width="6" height="6" rx="1" className={`square square-3 ${toggles.allDeviceIsOn ? 'light-up' : ''}`}></rect>
                                <rect x="9" y="9" width="6" height="6" rx="1" className={`square square-4 ${toggles.allDeviceIsOn ? 'light-up' : ''}`}></rect>
                            </svg>

                            <style jsx>{`
                            .square {
                                fill: #FFD700;
                                opacity: 0.2; /* Bắt đầu mờ */
                            }

                            /* Thêm animation liên tục cho từng ô */
                            .light-up {
                                animation: lightUpSequence 2s infinite linear; /* Animation lặp lại liên tục */
                            }

                            /* Điều chỉnh độ trễ cho từng ô */
                            .square-1.light-up {
                                animation-delay: 0s;
                            }

                            .square-2.light-up {
                                animation-delay: 1s; /* Trễ 0.5 giây sau ô 1 */
                            }

                            .square-3.light-up {
                                animation-delay: 1.5s; /* Trễ 1 giây sau ô 1 */
                            }

                            .square-4.light-up {
                                animation-delay: 2s; /* Trễ 1.5 giây sau ô 1 */
                            }
