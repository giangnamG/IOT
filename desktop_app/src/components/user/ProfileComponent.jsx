                            ...
                            <MDBCardBody className="p-0">
                                <MDBListGroup flush className="rounded-3">
                                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                                        ...
                                        <MDBCardText><a className='custom-link' href='/storages/pdf/Nguyễn Giang Nam - B21DCAT014 - Báo Cáo IOT.pdf'>View Project</a></MDBCardText>
                                    </MDBListGroupItem>
                                    <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    ...
                    <MDBCol lg="8">
                        ...
                        <MDBRow>
                            ...
                            <MDBCol md="6">
                                <MDBCard className="mb-4 mb-md-0">
                                    <MDBCardBody>
                                        <MDBCardText className="mb-4"><span className="text-primary font-italic me-1">System Design</span> Multi Thread</MDBCardText>
